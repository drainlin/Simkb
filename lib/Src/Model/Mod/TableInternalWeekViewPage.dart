...
import 'package:calendar_view/src/components/_internal_components.dart';
...
class TableInternalWeekViewPage<T extends Object?> extends StatelessWidget {
  /// Width of the page.
  final double width;
  ...
  /// A single page for week view.
  const TableInternalWeekViewPage({
    Key? key,
