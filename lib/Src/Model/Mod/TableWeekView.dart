...
import 'package:calendar_view/src/calendar_constants.dart';
...
import 'package:calendar_view/src/components/components.dart';
import 'package:calendar_view/src/components/event_scroll_notifier.dart';
import 'package:calendar_view/src/components/safe_area_wrapper.dart';
import 'package:calendar_view/src/constants.dart';
import 'package:calendar_view/src/enumerations.dart';
import 'package:calendar_view/src/event_arrangers/event_arrangers.dart';
import 'package:calendar_view/src/event_controller.dart';
import 'package:calendar_view/src/extensions.dart';
import 'package:calendar_view/src/modals.dart';
import 'package:calendar_view/src/style/header_style.dart';
import 'package:calendar_view/src/typedefs.dart';
import 'package:get/get.dart';
import 'package:simkb/Src/Model/Mod/TableInternalWeekViewPage.dart';
import 'package:simkb/Src/Utility/Global.dart';

/// [Widget] to display week view.
class TableWeekView<T extends Object?> extends StatefulWidget {
  ...
  @override
  TableWeekViewState<T> createState() => TableWeekViewState<T>();
}

class TableWeekViewState<T extends Object?> extends State<TableWeekView<T>> {
  late double _width;
  late double _height;
  ...
  Widget _defaultWeekDayBuilder(DateTime date) {
    final weekTitles = ["周一", "周二", "周三", "周四", "周五", "周六", "周日"];
    return Center(
      child: Column(
        mainAxisSize: MainAxisSize.min,
  ...
  Widget _defaultWeekNumberBuilder(DateTime date) {
    ...
    return GestureDetector(
      ...
      child: Center(
        child: Text("第${weekNumber < 1 ? 1 : weekNumber}周"),
      ),
    );
  }
